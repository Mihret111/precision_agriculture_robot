(define (problem problem_q2_wrong_intervention_classified_damage_resource_safety)
  ...
  (:init
    ...
    ;; Healthy plot: all interventions should be classified as not needed
  ...
  ;;  after classification says treatment is unnecessary, an unsafe fertilizer action causes damage
  (:goal (treatment-damaged plot1))
