(define (problem problem_q2_pest_spread_dynamic_spray_verified_report_resource_safety)
  ...
  (:init
    ...
    ;; Pest pressure starts just below threshold and crosses it while the robot travels/senses
    ...
    (= (pest-level plot1) 4.8)
    (= (pest-threshold plot1) 5)
    (= (pest-growth-rate plot1) 0.3)
  ...
  ;; demonstrates pest-spread dynamicstoo not only moisture dynamics
  (:goal (reported plot1))
