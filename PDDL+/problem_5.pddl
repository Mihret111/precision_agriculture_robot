(define (problem problem_q2_resource_limited_irrigation_report)
  ...
  (:init
    ...
    (= (moisture-stress-rate plot1) 0.2)
  ...
  (:goal (resource-limited-reported plot1))
